...
export interface EditorState {
  ...
  app: {
    ...
    studioEndpointUrl: string | null; // e.g. "http://studio.local.openedx.io:8001" TODO: move to EditorContext
    lmsEndpointUrl: string | null; // e.g. "http://local.openedx.io:8000" TODO: move to EditorContext
